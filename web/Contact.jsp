                ...
                <form class="form-horizontal" method="POST">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="telefoon" name="telefoon" type="text" placeholder="Telefoon" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" id="bericht" name="bericht" placeholder="Voer hier uw bericht in." rows="7"></textarea>
                            </div>
                        </div>
